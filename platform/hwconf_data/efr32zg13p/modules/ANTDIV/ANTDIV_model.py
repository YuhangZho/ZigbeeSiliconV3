...
options = {
    ...
    "HAL_RFPATH_SELECT": {
        "type": "enum",
        "description": "RF Path configuration",
        "values": [types.EnumValue('0', 'RF Path 0'),
                   types.EnumValue('1', 'RF Path 1'),
                   types.EnumValue('2', 'Default RF Path')],
        "dependency": dep.Dependency(sdid=[200]),
        "defaultValue": "Default RF Path",
        "longdescription": "Allows to select internal RF Path. No selection or Default option will automatically select the RF path based on the part.",
    },
}
