...
class CALC_Synth_lynx(CALC_Synth_panther):
    ...
    def buildVariables(self, model):
        ...
        self._addModelVariable(model, 'enable_retime', int, ModelVariableFormat.DECIMAL, desc='Enable retiming.')
    ...
    def calc_enable_retime(self, model):

        #For now, always disable retiming
        model.vars.enable_retime.value = 0
