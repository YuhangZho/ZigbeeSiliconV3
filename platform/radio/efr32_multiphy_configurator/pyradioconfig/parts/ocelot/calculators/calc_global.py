...
class CALC_Global_ocelot(CALC_Global_lynx):
    ...
    def buildVariables(self, model):
        ...
        self._addModelVariable(model, 'delay_adc_to_demod', int, ModelVariableFormat.DECIMAL)
...
#        self._addModelRegister(model, 'MODEM.BCRDEMODRSSI.RSSIMASEL', int, ModelVariableFormat.HEX)
        ...
        self._addModelRegister(model, 'RAC.PATRIM3.TXTRIMDREGSLICES', int, ModelVariableFormat.HEX)
        ...
        self._addModelRegister(model, 'RAC.SYLOEN.SYLODIVRLOSUBGRADCCLKEN', int, ModelVariableFormat.HEX)
