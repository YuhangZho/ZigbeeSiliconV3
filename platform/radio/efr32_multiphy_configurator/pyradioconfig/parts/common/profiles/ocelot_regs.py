...
def build_modem_regs_ocelot(model,profile, family):
    ...
    # Ocelot shared
    if model.part_family.lower() in ["ocelot", "bobcat", "sol"]:
...
#    profile.outputs.append(ModelOutput(model.vars.MODEM_BCRDEMODRSSI_RSSIMASEL, '', ModelOutputType.SVD_REG_FIELD,readable_name='MODEM.BCRDEMODRSSI.RSSIMASEL'))
    ...
    # Not in Sol.
    if model.part_family.lower() in ["ocelot", "bobcat"]:
    ...
    if model.part_family.lower() in ["ocelot", "sol"]:
        ...
        profile.outputs.append(ModelOutput(model.vars.RAC_PATRIM3_TXTRIMDREGSLICES, '',         ModelOutputType.SVD_REG_FIELD, readable_name='RAC.PATRIM3.TXTRIMDREGSLICES'           ))
        ...
        profile.outputs.append(ModelOutput(model.vars.RAC_SYLOEN_SYLODIVRLOSUBGRADCCLKEN, '', ModelOutputType.SVD_REG_FIELD, readable_name='RAC.SYLOEN.SYLODIVRLOSUBGRADCCLKEN'))
