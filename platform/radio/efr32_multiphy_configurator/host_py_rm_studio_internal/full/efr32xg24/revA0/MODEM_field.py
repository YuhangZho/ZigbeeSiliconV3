...
class RM_Field_MODEM_AFC_DISAFCSUPP(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_AFC_DISAFCSUPP, self).__init__(register,
            'DISAFCSUPP', 'MODEM.AFC.DISAFCSUPP', 'read-write',
            u"",
            31, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_MODEM_CHFCTRL_CTESWEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_CHFCTRL_CTESWEN, self).__init__(register,
            'CTESWEN', 'MODEM.CHFCTRL.CTESWEN', 'read-write',
            u"",
            29, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_CHFCTRL_CTECOESET(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_CHFCTRL_CTECOESET, self).__init__(register,
            'CTECOESET', 'MODEM.CHFCTRL.CTECOESET', 'read-write',
            u"",
            30, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_MODEM_ADPC3_ADBBSSAMPWAITEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_ADPC3_ADBBSSAMPWAITEN, self).__init__(register,
            'ADBBSSAMPWAITEN', 'MODEM.ADPC3.ADBBSSAMPWAITEN', 'read-write',
            u"",
            7, 1)
        self.__dict__['zz_frozen'] = True
