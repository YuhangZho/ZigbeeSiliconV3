...
class RM_Register_MODEM_AFC(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.DISAFCSUPP = RM_Field_MODEM_AFC_DISAFCSUPP(self)
        self.zz_fdict['DISAFCSUPP'] = self.DISAFCSUPP
        self.__dict__['zz_frozen'] = True
...
class RM_Register_MODEM_CHFCTRL(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.CTESWEN = RM_Field_MODEM_CHFCTRL_CTESWEN(self)
        self.zz_fdict['CTESWEN'] = self.CTESWEN
        self.CTECOESET = RM_Field_MODEM_CHFCTRL_CTECOESET(self)
        self.zz_fdict['CTECOESET'] = self.CTECOESET
...
class RM_Register_MODEM_ADPC3(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.ADBBSSAMPWAITEN = RM_Field_MODEM_ADPC3_ADBBSSAMPWAITEN(self)
        self.zz_fdict['ADBBSSAMPWAITEN'] = self.ADBBSSAMPWAITEN
