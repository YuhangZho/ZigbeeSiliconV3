...
class RM_Peripheral_FEFILT1(Base_RM_Peripheral):
    def __init__(self, rmio, label):
        ...
        self.SRCCHF = RM_Register_FEFILT1_SRCCHF(self.zz_rmio, self.zz_label)
        ...
        self.CHFLATENCYCTRL = RM_Register_FEFILT1_CHFLATENCYCTRL(self.zz_rmio, self.zz_label)
        ...
        self.MIXCTRL = RM_Register_FEFILT1_MIXCTRL(self.zz_rmio, self.zz_label)
