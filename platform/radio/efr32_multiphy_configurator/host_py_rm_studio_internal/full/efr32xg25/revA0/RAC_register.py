...
class RM_Register_RAC_PATRIM5(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.TXTRIMXPAVNC = RM_Field_RAC_PATRIM5_TXTRIMXPAVNC(self)
        self.zz_fdict['TXTRIMXPAVNC'] = self.TXTRIMXPAVNC
        self.TXTRIMXPAVPC = RM_Field_RAC_PATRIM5_TXTRIMXPAVPC(self)
        self.zz_fdict['TXTRIMXPAVPC'] = self.TXTRIMXPAVPC
        self.__dict__['zz_frozen'] = True
...
class RM_Register_RAC_RFPATHEN0(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.TXENVMIDPA0 = RM_Field_RAC_RFPATHEN0_TXENVMIDPA0(self)
        self.zz_fdict['TXENVMIDPA0'] = self.TXENVMIDPA0
        self.TXENDRVPA0 = RM_Field_RAC_RFPATHEN0_TXENDRVPA0(self)
        self.zz_fdict['TXENDRVPA0'] = self.TXENDRVPA0
        self.TXENPA0 = RM_Field_RAC_RFPATHEN0_TXENPA0(self)
        self.zz_fdict['TXENPA0'] = self.TXENPA0
        self.__dict__['zz_frozen'] = True
...
class RM_Register_RAC_RFPATHEN1(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.TXENVMIDPA1 = RM_Field_RAC_RFPATHEN1_TXENVMIDPA1(self)
        self.zz_fdict['TXENVMIDPA1'] = self.TXENVMIDPA1
        self.TXENDRVPA1 = RM_Field_RAC_RFPATHEN1_TXENDRVPA1(self)
        self.zz_fdict['TXENDRVPA1'] = self.TXENDRVPA1
        self.TXENPA1 = RM_Field_RAC_RFPATHEN1_TXENPA1(self)
        self.zz_fdict['TXENPA1'] = self.TXENPA1
        self.__dict__['zz_frozen'] = True
...
class RM_Register_RAC_TX(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.TXENRFPKD = RM_Field_RAC_TX_TXENRFPKD(self)
        self.zz_fdict['TXENRFPKD'] = self.TXENRFPKD
        self.TXENSH = RM_Field_RAC_TX_TXENSH(self)
        ...
        self.TXMODEPACMOS = RM_Field_RAC_TX_TXMODEPACMOS(self)
        self.zz_fdict['TXMODEPACMOS'] = self.TXMODEPACMOS
        self.TXMODEPASWITCH = RM_Field_RAC_TX_TXMODEPASWITCH(self)
        self.zz_fdict['TXMODEPASWITCH'] = self.TXMODEPASWITCH
        self.TXPDPASUPSWFAST = RM_Field_RAC_TX_TXPDPASUPSWFAST(self)
        self.zz_fdict['TXPDPASUPSWFAST'] = self.TXPDPASUPSWFAST
        self.TXSELVMID2VDDL = RM_Field_RAC_TX_TXSELVMID2VDDL(self)
        self.zz_fdict['TXSELVMID2VDDL'] = self.TXSELVMID2VDDL
...
class RM_Register_RAC_PATRIM6(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.TXTRIMBBDREGIOUT = RM_Field_RAC_PATRIM6_TXTRIMBBDREGIOUT(self)
        self.zz_fdict['TXTRIMBBDREGIOUT'] = self.TXTRIMBBDREGIOUT
        self.TXTRIMBBDREGVREG = RM_Field_RAC_PATRIM6_TXTRIMBBDREGVREG(self)
        self.zz_fdict['TXTRIMBBDREGVREG'] = self.TXTRIMBBDREGVREG
...
class RM_Register_RAC_PATRIM7(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.TXTRIMMIXREGFB = RM_Field_RAC_PATRIM7_TXTRIMMIXREGFB(self)
        self.zz_fdict['TXTRIMMIXREGFB'] = self.TXTRIMMIXREGFB
        self.TXTRIMMIXREGVREF = RM_Field_RAC_PATRIM7_TXTRIMMIXREGVREF(self)
        self.zz_fdict['TXTRIMMIXREGVREF'] = self.TXTRIMMIXREGVREF
        self.TXTRIMSHDREGVREG = RM_Field_RAC_PATRIM7_TXTRIMSHDREGVREG(self)
        self.zz_fdict['TXTRIMSHDREGVREG'] = self.TXTRIMSHDREGVREG
...
class RM_Register_RAC_PATRIM8(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.TXTRIMRFPKDDREGVREG = RM_Field_RAC_PATRIM8_TXTRIMRFPKDDREGVREG(self)
        self.zz_fdict['TXTRIMRFPKDDREGVREG'] = self.TXTRIMRFPKDDREGVREG
...
class RM_Register_RAC_PATRIM9(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.TXTRIMPASUPSWSLICES = RM_Field_RAC_PATRIM9_TXTRIMPASUPSWSLICES(self)
        self.zz_fdict['TXTRIMPASUPSWSLICES'] = self.TXTRIMPASUPSWSLICES
        self.TXTRIMVMIDAMPBIAS = RM_Field_RAC_PATRIM9_TXTRIMVMIDAMPBIAS(self)
        self.zz_fdict['TXTRIMVMIDAMPBIAS'] = self.TXTRIMVMIDAMPBIAS
        self.TXTRIMVMIDPA0 = RM_Field_RAC_PATRIM9_TXTRIMVMIDPA0(self)
        self.zz_fdict['TXTRIMVMIDPA0'] = self.TXTRIMVMIDPA0
        self.TXTRIMVMIDPA1 = RM_Field_RAC_PATRIM9_TXTRIMVMIDPA1(self)
        self.zz_fdict['TXTRIMVMIDPA1'] = self.TXTRIMVMIDPA1
        self.__dict__['zz_frozen'] = True
...
class RM_Register_RAC_TXRFPKD(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        super(RM_Register_RAC_TXRFPKD, self).__init__(rmio, label,
            ...
            u"",
            0x00000000, 0x0071F71F,
            0x00001000, 0x00002000,
            0x00003000)

        self.TXRESETRFPKD = RM_Field_RAC_TXRFPKD_TXRESETRFPKD(self)
        self.zz_fdict['TXRESETRFPKD'] = self.TXRESETRFPKD
        self.TXSELRFPKDINPUT = RM_Field_RAC_TXRFPKD_TXSELRFPKDINPUT(self)
        self.zz_fdict['TXSELRFPKDINPUT'] = self.TXSELRFPKDINPUT
...
class RM_Register_RAC_TXSTATUS(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.STATUSTXRFPKD = RM_Field_RAC_TXSTATUS_STATUSTXRFPKD(self)
        self.zz_fdict['STATUSTXRFPKD'] = self.STATUSTXRFPKD
        self.__dict__['zz_frozen'] = True
...
class RM_Register_RAC_TXOFDM(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.TXENBBDREG = RM_Field_RAC_TXOFDM_TXENBBDREG(self)
        self.zz_fdict['TXENBBDREG'] = self.TXENBBDREG
        ...
        self.TXENDACCODESWAPI = RM_Field_RAC_TXOFDM_TXENDACCODESWAPI(self)
        self.zz_fdict['TXENDACCODESWAPI'] = self.TXENDACCODESWAPI
        self.TXENDACCODESWAPQ = RM_Field_RAC_TXOFDM_TXENDACCODESWAPQ(self)
        self.zz_fdict['TXENDACCODESWAPQ'] = self.TXENDACCODESWAPQ
        self.TXENDACI = RM_Field_RAC_TXOFDM_TXENDACI(self)
        self.zz_fdict['TXENDACI'] = self.TXENDACI
        self.TXENDACQ = RM_Field_RAC_TXOFDM_TXENDACQ(self)
        self.zz_fdict['TXENDACQ'] = self.TXENDACQ
        self.TXENMIX = RM_Field_RAC_TXOFDM_TXENMIX(self)
        self.zz_fdict['TXENMIX'] = self.TXENMIX
        self.TXENMIXREG = RM_Field_RAC_TXOFDM_TXENMIXREG(self)
        self.zz_fdict['TXENMIXREG'] = self.TXENMIXREG
        self.TXENMIXREGBLEED = RM_Field_RAC_TXOFDM_TXENMIXREGBLEED(self)
        self.zz_fdict['TXENMIXREGBLEED'] = self.TXENMIXREGBLEED
        self.TXENMIXREGSTARTUP = RM_Field_RAC_TXOFDM_TXENMIXREGSTARTUP(self)
        self.zz_fdict['TXENMIXREGSTARTUP'] = self.TXENMIXREGSTARTUP
        ...
        self.TXENPASUPSW = RM_Field_RAC_TXOFDM_TXENPASUPSW(self)
        self.zz_fdict['TXENPASUPSW'] = self.TXENPASUPSW
        self.TXENSHATTN = RM_Field_RAC_TXOFDM_TXENSHATTN(self)
        self.zz_fdict['TXENSHATTN'] = self.TXENSHATTN
...
class RM_Register_RAC_SPACER(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.SYSPACER2 = RM_Field_RAC_SPACER_SYSPACER2(self)
        self.zz_fdict['SYSPACER2'] = self.SYSPACER2
        self.RXSPACER3 = RM_Field_RAC_SPACER_RXSPACER3(self)
        self.zz_fdict['RXSPACER3'] = self.RXSPACER3
        self.TXSPACER4 = RM_Field_RAC_SPACER_TXSPACER4(self)
        self.zz_fdict['TXSPACER4'] = self.TXSPACER4
        self.__dict__['zz_frozen'] = True
...
class RM_Register_RAC_SOFTMODEM(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_RAC_SOFTMODEM, self).__init__(rmio, label,
            0xa8020000, 0x3D4,
            'SOFTMODEM', 'RAC.SOFTMODEM', 'read-write',
            u"",
            0x00000000, 0x00000003,
            0x00001000, 0x00002000,
            0x00003000)

        self.EN = RM_Field_RAC_SOFTMODEM_EN(self)
        self.zz_fdict['EN'] = self.EN
        self.RUNNING = RM_Field_RAC_SOFTMODEM_RUNNING(self)
