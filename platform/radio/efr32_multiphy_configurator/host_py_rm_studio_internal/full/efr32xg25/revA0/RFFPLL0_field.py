...
class RM_Field_RFFPLL0_SWRST_SWRST(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RFFPLL0_SWRST_SWRST, self).__init__(register,
            'SWRST', 'RFFPLL0.SWRST.SWRST', 'write-only',
            u"",
            0, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RFFPLL0_SWRST_RESETTING(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RFFPLL0_SWRST_RESETTING, self).__init__(register,
            'RESETTING', 'RFFPLL0.SWRST.RESETTING', 'read-only',
            u"",
            1, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RFFPLL0_RFBIASCTRL_NONFLASHMODE(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RFFPLL0_RFBIASCTRL_NONFLASHMODE, self).__init__(register,
            'NONFLASHMODE', 'RFFPLL0.RFBIASCTRL.NONFLASHMODE', 'read-write',
            u"",
            1, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RFFPLL0_RFBIASCTRL_LDOHIGHCURRENT(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RFFPLL0_RFBIASCTRL_LDOHIGHCURRENT, self).__init__(register,
            'LDOHIGHCURRENT', 'RFFPLL0.RFBIASCTRL.LDOHIGHCURRENT', 'read-write',
            u"",
            2, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RFFPLL0_RFFPLLCTRL_ADCPHASEFLIP(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RFFPLL0_RFFPLLCTRL_ADCPHASEFLIP, self).__init__(register,
            'ADCPHASEFLIP', 'RFFPLL0.RFFPLLCTRL.ADCPHASEFLIP', 'read-write',
            u"",
            3, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RFFPLL0_RFFPLLCTRL_DIGPHASEFLIP(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RFFPLL0_RFFPLLCTRL_DIGPHASEFLIP, self).__init__(register,
            'DIGPHASEFLIP', 'RFFPLL0.RFFPLLCTRL.DIGPHASEFLIP', 'read-write',
            u"",
            4, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RFFPLL0_RFFPLLCAL1_DIVN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RFFPLL0_RFFPLLCAL1_DIVN, self).__init__(register,
            'DIVN', 'RFFPLL0.RFFPLLCAL1.DIVN', 'read-write',
            u"",
            0, 7)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RFFPLL0_RFFPLLCAL1_DIVX(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RFFPLL0_RFFPLLCAL1_DIVX, self).__init__(register,
            'DIVX', 'RFFPLL0.RFFPLLCAL1.DIVX', 'read-write',
            u"",
            12, 4)
        self.__dict__['zz_frozen'] = True


class RM_Field_RFFPLL0_RFFPLLCAL1_DIVY(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RFFPLL0_RFFPLLCAL1_DIVY, self).__init__(register,
            'DIVY', 'RFFPLL0.RFFPLLCAL1.DIVY', 'read-write',
            u"",
            16, 5)
        self.__dict__['zz_frozen'] = True


class RM_Field_RFFPLL0_RFFPLLCAL1_DIVXDACSEL(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RFFPLL0_RFFPLLCAL1_DIVXDACSEL, self).__init__(register,
            'DIVXDACSEL', 'RFFPLL0.RFFPLLCAL1.DIVXDACSEL', 'read-write',
            u"",
            24, 4)
        self.__dict__['zz_frozen'] = True


class RM_Field_RFFPLL0_RFFPLLCAL1_DIVXMODEMSEL(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RFFPLL0_RFFPLLCAL1_DIVXMODEMSEL, self).__init__(register,
            'DIVXMODEMSEL', 'RFFPLL0.RFFPLLCAL1.DIVXMODEMSEL', 'read-write',
            u"",
            28, 2)
        self.__dict__['zz_frozen'] = True


class RM_Field_RFFPLL0_RFFPLLCAL1_DIVXADCSEL(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RFFPLL0_RFFPLLCAL1_DIVXADCSEL, self).__init__(register,
            'DIVXADCSEL', 'RFFPLL0.RFFPLLCAL1.DIVXADCSEL', 'read-write',
            u"",
            30, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RFFPLL0_RFFPLLCAL1_DIVYSEL(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RFFPLL0_RFFPLLCAL1_DIVYSEL, self).__init__(register,
            'DIVYSEL', 'RFFPLL0.RFFPLLCAL1.DIVYSEL', 'read-write',
            u"",
            31, 1)
        self.__dict__['zz_frozen'] = True
