...
class RM_Register_RFFPLL0_SWRST(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_RFFPLL0_SWRST, self).__init__(rmio, label,
            0x400c8000, 0x008,
            'SWRST', 'RFFPLL0.SWRST', 'read-write',
            u"",
            0x00000000, 0x00000003,
            0x00001000, 0x00002000,
            0x00003000)

        self.SWRST = RM_Field_RFFPLL0_SWRST_SWRST(self)
        self.zz_fdict['SWRST'] = self.SWRST
        self.RESETTING = RM_Field_RFFPLL0_SWRST_RESETTING(self)
...
class RM_Register_RFFPLL0_RFBIASCTRL(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.NONFLASHMODE = RM_Field_RFFPLL0_RFBIASCTRL_NONFLASHMODE(self)
        self.zz_fdict['NONFLASHMODE'] = self.NONFLASHMODE
        self.LDOHIGHCURRENT = RM_Field_RFFPLL0_RFBIASCTRL_LDOHIGHCURRENT(self)
...
class RM_Register_RFFPLL0_RFFPLLCTRL(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.ADCPHASEFLIP = RM_Field_RFFPLL0_RFFPLLCTRL_ADCPHASEFLIP(self)
        self.zz_fdict['ADCPHASEFLIP'] = self.ADCPHASEFLIP
        self.DIGPHASEFLIP = RM_Field_RFFPLL0_RFFPLLCTRL_DIGPHASEFLIP(self)
...
class RM_Register_RFFPLL0_RFFPLLCAL1(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        super(RM_Register_RFFPLL0_RFFPLLCAL1, self).__init__(rmio, label,
            ...
            u"",
            0x14126130, 0xFF1FF77F,
            0x00001000, 0x00002000,
            0x00003000)

        self.DIVN = RM_Field_RFFPLL0_RFFPLLCAL1_DIVN(self)
        self.zz_fdict['DIVN'] = self.DIVN
        self.DIVR = RM_Field_RFFPLL0_RFFPLLCAL1_DIVR(self)
        self.zz_fdict['DIVR'] = self.DIVR
        self.DIVX = RM_Field_RFFPLL0_RFFPLLCAL1_DIVX(self)
        self.zz_fdict['DIVX'] = self.DIVX
        self.DIVY = RM_Field_RFFPLL0_RFFPLLCAL1_DIVY(self)
        self.zz_fdict['DIVY'] = self.DIVY
        self.DIVXDACSEL = RM_Field_RFFPLL0_RFFPLLCAL1_DIVXDACSEL(self)
        self.zz_fdict['DIVXDACSEL'] = self.DIVXDACSEL
        self.DIVXMODEMSEL = RM_Field_RFFPLL0_RFFPLLCAL1_DIVXMODEMSEL(self)
        self.zz_fdict['DIVXMODEMSEL'] = self.DIVXMODEMSEL
        self.DIVXADCSEL = RM_Field_RFFPLL0_RFFPLLCAL1_DIVXADCSEL(self)
        self.zz_fdict['DIVXADCSEL'] = self.DIVXADCSEL
        self.DIVYSEL = RM_Field_RFFPLL0_RFFPLLCAL1_DIVYSEL(self)
