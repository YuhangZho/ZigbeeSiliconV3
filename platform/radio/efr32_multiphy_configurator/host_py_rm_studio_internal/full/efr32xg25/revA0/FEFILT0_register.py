...
class RM_Register_FEFILT0_CF(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.DEC2 = RM_Field_FEFILT0_CF_DEC2(self)
        self.zz_fdict['DEC2'] = self.DEC2
        self.CFOSR = RM_Field_FEFILT0_CF_CFOSR(self)
        self.zz_fdict['CFOSR'] = self.CFOSR
        self.DEC1GAIN = RM_Field_FEFILT0_CF_DEC1GAIN(self)
...
class RM_Register_FEFILT0_SRCCHF(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_FEFILT0_SRCCHF, self).__init__(rmio, label,
            0xa8040000, 0x104,
            'SRCCHF', 'FEFILT0.SRCCHF', 'read-write',
            u"",
            0x00000000, 0xBFFFF000,
            0x00001000, 0x00002000,
            0x00003000)

        self.SRCRATIO2 = RM_Field_FEFILT0_SRCCHF_SRCRATIO2(self)
        self.zz_fdict['SRCRATIO2'] = self.SRCRATIO2
        self.SRCENABLE2 = RM_Field_FEFILT0_SRCCHF_SRCENABLE2(self)
        self.zz_fdict['SRCENABLE2'] = self.SRCENABLE2
        self.SRCDEC2 = RM_Field_FEFILT0_SRCCHF_SRCDEC2(self)
        self.zz_fdict['SRCDEC2'] = self.SRCDEC2
        self.INTOSR = RM_Field_FEFILT0_SRCCHF_INTOSR(self)
...
class RM_Register_FEFILT0_DIGIGAINCTRL(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.DIGIGAINSEL = RM_Field_FEFILT0_DIGIGAINCTRL_DIGIGAINSEL(self)
        self.zz_fdict['DIGIGAINSEL'] = self.DIGIGAINSEL
        self.DIGIGAINDOUBLE = RM_Field_FEFILT0_DIGIGAINCTRL_DIGIGAINDOUBLE(self)
        self.zz_fdict['DIGIGAINDOUBLE'] = self.DIGIGAINDOUBLE
        self.DIGIGAINHALF = RM_Field_FEFILT0_DIGIGAINCTRL_DIGIGAINHALF(self)
...
class RM_Register_FEFILT0_CHFLATENCYCTRL(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_FEFILT0_CHFLATENCYCTRL, self).__init__(rmio, label,
            0xa8040000, 0x148,
            'CHFLATENCYCTRL', 'FEFILT0.CHFLATENCYCTRL', 'read-write',
            u"",
            0x00000000, 0x00000003,
            0x00001000, 0x00002000,
            0x00003000)

        self.CHFLATENCY = RM_Field_FEFILT0_CHFLATENCYCTRL_CHFLATENCY(self)
...
class RM_Register_FEFILT0_DIGMIXCTRL(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.DIGMIXMODE = RM_Field_FEFILT0_DIGMIXCTRL_DIGMIXMODE(self)
        ...
        self.DIGMIXFB = RM_Field_FEFILT0_DIGMIXCTRL_DIGMIXFB(self)
        self.zz_fdict['DIGMIXFB'] = self.DIGMIXFB
        self.__dict__['zz_frozen'] = True


class RM_Register_FEFILT0_MIXCTRL(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_FEFILT0_MIXCTRL, self).__init__(rmio, label,
            0xa8040000, 0x184,
            'MIXCTRL', 'FEFILT0.MIXCTRL', 'read-write',
            u"",
            0x00000000, 0x00000010,
            0x00001000, 0x00002000,
            0x00003000)

        self.DIGIQSWAPEN = RM_Field_FEFILT0_MIXCTRL_DIGIQSWAPEN(self)
