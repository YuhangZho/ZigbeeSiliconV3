...
class RM_Peripheral_FEFILT0(Base_RM_Peripheral):
    def __init__(self, rmio, label):
        ...
        self.SRCCHF = RM_Register_FEFILT0_SRCCHF(self.zz_rmio, self.zz_label)
        ...
        self.CHFLATENCYCTRL = RM_Register_FEFILT0_CHFLATENCYCTRL(self.zz_rmio, self.zz_label)
        ...
        self.MIXCTRL = RM_Register_FEFILT0_MIXCTRL(self.zz_rmio, self.zz_label)
