...
class MultiPHYStudioPropFileImport(object):
    ...
    def run(self, radioconf_filename, output_directory, output_filename=None, internal=False):
        ...
        if int(multi_phy_model.status_code) != ModelDiffCodes.UNKNOWN_ERROR.value:
            RAILScriptsWrapper.run_rail_scripts(multi_phy_model, output_filename=output_filename, internal=internal)
