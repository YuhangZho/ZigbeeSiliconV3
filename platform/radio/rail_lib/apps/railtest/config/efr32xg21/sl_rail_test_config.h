...
// <i> Default: 0
#define SL_RAIL_TEST_RADIO_CONFIG_EXTERNAL_SUPPORT_ENABLED 0
...
// <i> Default: RADIO_CONFIG_INTERNAL_BLE_1MBPS
#define SL_RAIL_TEST_RADIO_CONFIG_DEFAULT  RADIO_CONFIG_INTERNAL_BLE_1MBPS
