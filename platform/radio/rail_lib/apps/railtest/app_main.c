...
#if SL_RAIL_UTIL_TRANSITIONS_ENABLE
RAIL_RadioState_t rxSuccessTransition = SL_RAIL_UTIL_TRANSITION_RX_SUCCESS;
#else
...
void sl_rail_test_internal_app_init(void)
{
  ...
  sl_rail_util_rf_path_init_tx_options(&txOptions);
  sl_rail_util_rf_path_init_rx_options(&rxOptions);
  ...
  channel = applyDefaultRadioConfig(railHandle, SL_RAIL_TEST_RADIO_CONFIG_DEFAULT);
