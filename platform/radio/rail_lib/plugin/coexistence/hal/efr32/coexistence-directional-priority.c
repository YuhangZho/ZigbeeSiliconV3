...
#define SL_RAIL_UTIL_COEX_DP_CC0_INTNO SL_RAIL_UTIL_COEX_PWM_REQ_INTNO
#ifdef _SILICON_LABS_32B_SERIES_1
STATIC_ASSERT(SL_RAIL_UTIL_COEX_DP_CC0_PORT == SL_RAIL_UTIL_COEX_PWM_REQ_PORT, "SL_RAIL_UTIL_COEX_DP_CC0_PORT must match SL_RAIL_UTIL_COEX_PWM_REQ_PORT");
STATIC_ASSERT(SL_RAIL_UTIL_COEX_DP_CC0_PIN == SL_RAIL_UTIL_COEX_PWM_REQ_PIN, "SL_RAIL_UTIL_COEX_DP_CC0_PIN must match SL_RAIL_UTIL_COEX_PWM_REQ_PIN");
#else //!_SILICON_LABS_32B_SERIES_1
#define SL_RAIL_UTIL_COEX_DP_CC0_PORT (SL_RAIL_UTIL_COEX_PWM_REQ_PORT)
#define SL_RAIL_UTIL_COEX_DP_CC0_PIN (SL_RAIL_UTIL_COEX_PWM_REQ_PIN)
#endif //_SILICON_LABS_32B_SERIES_1
#else //!SL_RAIL_UTIL_COEX_PWM_REQ_PORT
#define SL_RAIL_UTIL_COEX_DP_CC0_INTNO SL_RAIL_UTIL_COEX_REQ_INTNO
#ifdef _SILICON_LABS_32B_SERIES_1
STATIC_ASSERT(SL_RAIL_UTIL_COEX_DP_CC0_PORT == SL_RAIL_UTIL_COEX_REQ_PORT, "SL_RAIL_UTIL_COEX_DP_CC0_PORT must match SL_RAIL_UTIL_COEX_REQ_PORT");
STATIC_ASSERT(SL_RAIL_UTIL_COEX_DP_CC0_PIN == SL_RAIL_UTIL_COEX_REQ_PIN, "SL_RAIL_UTIL_COEX_DP_CC0_PIN must match SL_RAIL_UTIL_COEX_REQ_PIN");
#else //!_SILICON_LABS_32B_SERIES_1
#define SL_RAIL_UTIL_COEX_DP_CC0_PORT (SL_RAIL_UTIL_COEX_REQ_PORT)
#define SL_RAIL_UTIL_COEX_DP_CC0_PIN (SL_RAIL_UTIL_COEX_REQ_PIN)
#endif //_SILICON_LABS_32B_SERIES_1
...
#define SL_RAIL_UTIL_COEX_DP_TIMER_ADDR STRIP_TYPECAST(SL_RAIL_UTIL_COEX_DP_PERIPHERAL)
...
#error "Unrecognized timer selection!"
#endif
#define SL_RAIL_UTIL_COEX_DP_TIMER SL_RAIL_UTIL_COEX_DP_PERIPHERAL
#endif //HAL_CONFIG
...
static bool configDpTimer(uint8_t pulseWidthUs)
{
  ...
  BUS_RegMaskedWrite(&SL_RAIL_UTIL_COEX_DP_TIMER->ROUTELOC0,
                     _TIMER_ROUTELOC0_CC0LOC_MASK,
                     SL_RAIL_UTIL_COEX_DP_CC0_LOC);
  #else // !_SILICON_LABS_32B_SERIES_1
  ...
  SL_RAIL_UTIL_COEX_DP_TIMER->CC[0].CTRL = TIMER_CC_CTRL_OUTINV
                                           | TIMER_CC_CTRL_CMOA_SET;
  GPIO->TIMERROUTE[TIMER_DEVICE_ID(SL_RAIL_UTIL_COEX_DP_TIMER)].CC0ROUTE = (SL_RAIL_UTIL_COEX_DP_CC0_PORT << _GPIO_TIMER_CC0ROUTE_PORT_SHIFT)
                                                                           | (SL_RAIL_UTIL_COEX_DP_CC0_PIN
...
PRS_ChannelConfig_t prsChainOff[] = {
#ifdef SL_RAIL_UTIL_COEX_PRI_INTNO
  {
    ...
    .ctrl = prsLogic_A,
#endif
    .channel = SL_RAIL_UTIL_COEX_DP_CHANNEL
  }
#elif defined(_SILICON_LABS_32B_SERIES_1) //!defined(SL_RAIL_UTIL_COEX_PRI_INTNO)
  {
    ...
    .channel = WRAP_PRS_ASYNC(SL_RAIL_UTIL_COEX_DP_CHANNEL - 2)
  },
  {
    .source = PRS_CHANNEL_SOURCE(SL_RAIL_UTIL_COEX_DP_REQUEST_INV_CHANNEL),
    .signal = PRS_CHANNEL_SIGNAL(SL_RAIL_UTIL_COEX_DP_REQUEST_INV_CHANNEL),
    .ctrl = PRS_CH_CTRL_ORPREV | PRS_CH_CTRL_INV,
    .channel = WRAP_PRS_ASYNC(SL_RAIL_UTIL_COEX_DP_CHANNEL - 1)
  },
  {
    .source = PRS_CHANNEL_SOURCE(SL_RAIL_UTIL_COEX_DP_REQUEST_INV_CHANNEL),
    .signal = PRS_CHANNEL_SIGNAL(SL_RAIL_UTIL_COEX_DP_REQUEST_INV_CHANNEL),
  ...
  {
    .source = PRS_GPIO_SOURCE(SL_RAIL_UTIL_COEX_DP_CC0_INTNO),
    .signal = PRS_GPIO_SIGNAL(SL_RAIL_UTIL_COEX_DP_CC0_INTNO),
    .ctrl = prsLogic_A,
    .channel = WRAP_PRS_ASYNC(SL_RAIL_UTIL_COEX_DP_CHANNEL - 2)
  },
  {
...
PRS_ChannelConfig_t prsChainOn[] = {
#ifdef SL_RAIL_UTIL_COEX_PRI_INTNO
  {
    ...
    .signal = PRS_GPIO_SIGNAL(SL_RAIL_UTIL_COEX_PRI_INTNO),
    .ctrl = prsLogic_A,
    .channel = WRAP_PRS_ASYNC(SL_RAIL_UTIL_COEX_DP_CHANNEL - 3)
  },
  {
...
bool COEX_HAL_ConfigDp(uint8_t pulseWidthUs)
{
  ...
  GPIO_ExtIntConfig(SL_RAIL_UTIL_COEX_DP_CC0_PORT,
                    SL_RAIL_UTIL_COEX_DP_CC0_PIN,
                    SL_RAIL_UTIL_COEX_DP_CC0_INTNO,
                    false,
                    false,
                    false);
  // Common PRS wrap-up (enable PRIORITY GPIO, route PRS output to GPIO)
  // enable PRIORITY output pin with initial value of 0
  GPIO_PinModeSet(SL_RAIL_UTIL_COEX_DP_PORT,
                  SL_RAIL_UTIL_COEX_DP_PIN,
  ...
  if (SL_RAIL_UTIL_COEX_DP_CHANNEL < 4) {
    routeRegister = &PRS->ROUTELOC0;
  } else if (SL_RAIL_UTIL_COEX_DP_CHANNEL < 8) {
    routeRegister = &PRS->ROUTELOC1;
  } else if (SL_RAIL_UTIL_COEX_DP_CHANNEL < 12) {
  ...
  BUS_RegMaskedWrite(routeRegister,
                     0xFFU << ((SL_RAIL_UTIL_COEX_DP_CHANNEL & 3) * 8),
                     SL_RAIL_UTIL_COEX_DP_LOC << ((SL_RAIL_UTIL_COEX_DP_CHANNEL & 3) * 8));
  BUS_RegMaskedSet(&PRS->ROUTEPEN, (1 << SL_RAIL_UTIL_COEX_DP_CHANNEL));
#else //!_SILICON_LABS_32B_SERIES_1
  PRS_PinOutput(SL_RAIL_UTIL_COEX_DP_CHANNEL, prsTypeAsync, SL_RAIL_UTIL_COEX_DP_PORT, SL_RAIL_UTIL_COEX_DP_PIN);
#endif //_SILICON_LABS_32B_SERIES_1
