 ...
 */
#if     (SL_RAIL_UTIL_COEX_ENABLE && defined(SL_RAIL_UTIL_COEX_RHO_PORT))
// Initial bootup configuration is for Radio HoldOff
  #define halInternalInitRadioHoldOff() halSetRadioHoldOff(true)
#else//!(SL_RAIL_UTIL_COEX_ENABLE && defined(SL_RAIL_UTIL_COEX_RHO_PORT))
// Initial bootup configuration is for default
  #define halInternalInitRadioHoldOff() /* no-op */
#endif//(SL_RAIL_UTIL_COEX_ENABLE && defined(SL_RAIL_UTIL_COEX_RHO_PORT))
...
#if     (SL_RAIL_UTIL_COEX_ENABLE && (defined(SL_RAIL_UTIL_COEX_REQ_PORT) || defined(SL_RAIL_UTIL_COEX_GNT_PORT)))
// Initial bootup configuration is to enable PTA
  #define halInternalInitPta() halPtaSetEnable(true)
#else//!(SL_RAIL_UTIL_COEX_ENABLE && (defined(SL_RAIL_UTIL_COEX_REQ_PORT) || defined(SL_RAIL_UTIL_COEX_GNT_PORT)))
// Initial bootup configuration is not to enable PTA
  #define halInternalInitPta() /* no-op */
#endif//(SL_RAIL_UTIL_COEX_ENABLE && (defined(SL_RAIL_UTIL_COEX_REQ_PORT) || defined(SL_RAIL_UTIL_COEX_GNT_PORT)))
