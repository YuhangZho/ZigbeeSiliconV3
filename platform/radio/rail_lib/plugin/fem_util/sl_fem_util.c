...
void sl_fem_util_init(void)
{
  ...
  BUS_RegMaskedWrite(routeRegister,
                     0xFF << ((SL_FEM_UTIL_TX_CHANNEL % 4) * 8),
                     SL_FEM_UTIL_TX_LOC << ((SL_FEM_UTIL_TX_CHANNEL % 4) * 8));
...
#error "No PRS setting defined for Source=RAC, Signal=PAEN"
  ...
  BUS_RegMaskedWrite(routeRegister,
                     0xFF << ((SL_FEM_UTIL_RX_CHANNEL % 4) * 8),
                     SL_FEM_UTIL_RX_LOC << ((SL_FEM_UTIL_RX_CHANNEL % 4) * 8));
...
// Configure CSD PRS output to selected channel and location
  ...
  BUS_RegMaskedWrite(routeRegister,
                     0xFF << ((SL_FEM_UTIL_SLEEP_CHANNEL % 4) * 8),
                     SL_FEM_UTIL_SLEEP_LOC << ((SL_FEM_UTIL_SLEEP_CHANNEL % 4) * 8));
