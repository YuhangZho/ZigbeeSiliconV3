 ...
 * by ::Rail_GetTime.
 *
 * (On EM3xx devices, the hardware MAC timer is 20 bits and ticks roughly every
 *  microsecond for a range of around 1 second.  Dumbo ticks every 2us while
 *  other platforms tick at 0.5us rate.  Make sure to adjust the relative
 *  timestamp value accordingly.)
 *
 * After a successful call to this function, the quantity
