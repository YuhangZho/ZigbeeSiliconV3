 ...
 *  means prent's keep alive mechanism is unknown to end-device.
 *
 *  EMBER_MAC_DATA_POLL_KEEP_ALIVE, means parent does not need explicit keep alive messages
 *  and will use incoming mac data polls as a sign that a child should not be aged out.
 *
 *  EMBER_END_DEVICE_TIMEOUT_KEEP_ALIVE, means parent needs explicit keep alive messages
 *  (net work timeoit requests) to keep the child in its child table.
 *
 *  EMBER_KEEP_ALIVE_SUPPORT_ALL bascially maps to EMBER_MAC_DATA_POLL_KEEP_ALIVE,
 *  as it is the prefered  approach between the 2
 */
#ifdef DOXYGEN_SHOULD_SKIP_THIS
 ...
 * sent once immidiately and then trifggered periodically
 */
#ifdef DOXYGEN_SHOULD_SKIP_THIS
