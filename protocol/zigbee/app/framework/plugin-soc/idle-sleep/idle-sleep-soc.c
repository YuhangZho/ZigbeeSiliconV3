...
#if defined(SL_CATALOG_POWER_MANAGER_PRESENT) && defined(CORTEXM3_EFR32) && defined(EMBER_AF_PLUGIN_MICRIUM_RTOS)
  // We don't want to go deeper than EM2 sleep mode in general.
  sl_power_manager_add_em_requirement(SL_POWER_MANAGER_EM2);
#endif //SL_CATALOG_POWER_MANAGER_PRESENT && CORTEXM3_EFR32 && EMBER_AF_PLUGIN_MICRIUM_RTOS
}
