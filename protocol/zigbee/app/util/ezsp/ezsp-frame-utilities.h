...
#if defined(EMBER_USE_BEACON_CACHE) || defined(EMBER_AF_PLUGIN_NETWORK_STEERING_OPTIMIZE_SCANS)
...
#else // defined(EMBER_USE_BEACON_CACHE) || defined(EMBER_AF_PLUGIN_NETWORK_STEERING_OPTIMIZE_SCANS)
  #define appendEmberBeaconIterator(value) (void)value
  #define fetchEmberBeaconIterator(value) (void)value
  #define appendEmberBeaconData(value) (void)value
  #define fetchEmberBeaconData(value) (void)value
#endif // defined(EMBER_USE_BEACON_CACHE) || defined(EMBER_AF_PLUGIN_NETWORK_STEERING_OPTIMIZE_SCANS)
