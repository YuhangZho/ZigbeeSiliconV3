...
class GattAttribute(object):
    def __init__(self, uuid="0000", id="", properties=0, ext_properties=0, permissions=GattConst.Discoverable|GattConst.Read, value=None,capabilities=[],ids=[]):
        if(type(uuid)==str):
