...
/// Public key size
#define PUB_KEY_SIZE    (SL_SE_CERT_KEY_SIZE)

/// Signature size
#define SIGNATURE_SIZE  (SL_SE_CERT_SIGN_SIZE)

/// Challenge size
#define CHALLENGE_SIZE  (SL_SE_CHALLENGE_SIZE)
 ...
 *
 * @param cert_type Type of the certificate, either SE or MCU.
