  ...
  switch (app_state) {
...
#else
      printf("\n  . Press PB0 to program 128-bit AES key in SE OTP or press "
             "PB1 to skip.\n");
    ...
    case CHECK_EXECUTED_COMMAND:
      ...
      if (check_executed_command() != SL_STATUS_OK) {
        printf("  + No executed command before, press PB0 to program public "
               "sign key in SE OTP or press PB1 to skip.\n");
    ...
    case CHECK_AES_KEY:
      ...
      printf("\n  . Press PB0 to program public sign key in SE OTP or press "
             "PB1 to skip.\n");
      app_state = PRE_INIT_PUB_SIGN_KEY;
      break;
#endif
...
#endif
      printf("\n  . Press PB0 to program public command key in SE OTP or press "
             "PB1 to skip.\n");
      break;
...
#endif
#if (_SILICON_LABS_SECURITY_FEATURE == _SILICON_LABS_SECURITY_FEATURE_VAULT)
      printf("\n  . Press PB0 to initialize SE OTP for secure boot and tamper "
             "configuration or press PB1 to skip.\n");
#else
      printf("\n  . Press PB0 to initialize SE OTP for secure boot "
             "configuration or press PB1 to skip.\n");
#endif
      break;
