...
void app_process_action(void)
{
  switch (app_state) {
    ...
    case PBKDF2_TEST1:
      ...
      if (derive_pbkdf2_key(SL_SE_HASH_SHA256, 1) == SL_STATUS_OK) {
    ...
    case PBKDF2_TEST2:
      ...
      if (derive_pbkdf2_key(SL_SE_HASH_SHA256, 2) == SL_STATUS_OK) {
        printf("  + Comparing generated PBKDF2 key with expected data... ");
    ...
    case PBKDF2_TEST3:
      ...
      if (derive_pbkdf2_key(SL_SE_HASH_SHA256, 4096) == SL_STATUS_OK) {
        printf("  + Comparing generated PBKDF2 key with expected data... ");
