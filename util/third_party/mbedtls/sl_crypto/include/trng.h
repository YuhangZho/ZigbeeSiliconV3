 ...
 * mbed TLS.
 * Selecting <b>Mbed TLS support for EFM32/EFR32 crypto acceleration</b>
 * component will compile the TRNG module. The TRNG functions are declared in
 *'mbedtls/sl_crypto/include/trng.h'.
 *
 * \{
 ******************************************************************************/
