 ...
 *
 * The <b>Mbed TLS support for radio entropy</b> component will compile this
 * module. By selecting <b>Mbed TLS support for random numbers using CTR_DRBG
 * </b> component the @ref mbedtls_hardware_poll() function implemented
 * in this module can be used. This will automatically register the
