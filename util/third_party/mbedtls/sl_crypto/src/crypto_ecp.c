                                        ...
                                        void *p_rng )
{
    ...
    /* Z = l * Z */
    /*In addition we do a modulus reduction l mod p to make sure that l is
     * smaller than p. This is done by using MADD with l and 0. */
    /* 0 is achived by doing l XOR l. */
    CRYPTO_EXECUTE_7 (  crypto,
                        CRYPTO_CMD_INSTR_SELDDATA1DDATA1,
